...
void median_rate(Pr* pr,Node** nodes, vector<double> dates, vector<int>* samples,bool addInternalDates,double& rate1, double& rate2);
...
vector<int> outliers_rooted(Pr* pr,Node** nodes,vector<int>* samples, vector<double> dates_min, vector<double> dates_max, bool addInternalDates, bool both,double& median_rate);
